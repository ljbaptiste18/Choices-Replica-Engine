...
define config.name = _("Choices Replica Engine")
...
define build.name = "ItLivesWithinObsidianCut"
...
define config.main_menu_music = "audio/into the night.mp3"
...
define build.itch_project = "the it lives project/It Lives Demo"
